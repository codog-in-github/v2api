        ...
        switch ($uri) {
            ...
            case 'admin/order/edit_order':
                return [
                    ...
                    'containers.*.details.*.van_place' => 'nullable|required',
                    'containers.*.details.*.van_type' => 'nullable|required',
                    'containers.*.details.*.bearing_type' => 'nullable|required',
                    'containers.*.details.*.deliver_day' => 'nullable|required',
                    'containers.*.details.*.deliver_time' => 'nullable|required',
                    'containers.*.details.*.trans_com' => 'nullable|required',
                    'containers.*.details.*.driver' => 'nullable|required',
                    'containers.*.details.*.tel' => 'nullable|required',
                    'containers.*.details.*.car' => 'nullable|required',
                    'containers.*.details.*.container' => 'nullable|required',
                    'containers.*.details.*.seal' => 'nullable|required',
                    'containers.*.details.*.tare' => 'nullable|required',
                ];
